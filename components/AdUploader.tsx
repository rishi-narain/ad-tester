...
import { Upload, X, FileText, Image as ImageIcon, Info, Link as LinkIcon } from "lucide-react";
...
interface AdUploaderProps {
  ...
  mode: "image" | "text" | "url";
  onModeChange: (mode: "image" | "text" | "url") => void;
}
    ...
    <div className="w-full">
      ...
      {mode === "image" && (
        <div
          ...
          onDrop={handleDrop}
          className={`relative border-2 border-dashed rounded-xl p-6 transition-all min-h-[280px] flex items-center justify-center ${
            isDragging
          ...
          {preview ? (
            <div className="relative w-full h-full flex items-center justify-center">
              <img
                src={preview}
                alt="Preview"
                className="max-h-[220px] max-w-full mx-auto rounded-lg shadow-lg object-contain"
              />
              <button
                onClick={clearImage}
      ...
      {/* Text Upload Mode */}
      {mode === "text" && (
        <div className="border-2 border-gray-300 rounded-xl p-6 bg-white min-h-[280px] flex flex-col">
          <textarea
            value={textContent}
      ...
      {/* URL Upload Mode */}
      {mode === "url" && (
        <div className="border-2 border-gray-300 rounded-xl p-6 bg-white min-h-[280px] flex items-center justify-center">
          <div className="text-center w-full">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent font-body text-gray-700"
            />
            <p className="text-xs text-gray-400 mt-2">
